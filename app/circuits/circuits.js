...
"data", "data", 1016980252), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "numPins", "numPins", 3307823510), 2, new cljs.core.Keyword(null, "wordLength", "wordLength", 2280059394), 1, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), new cljs.core.Keyword(null, "ip0", "ip0", 1014008667), new cljs.core.Keyword(null, 
...
"q", "q", 1013904355), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "numPins", "numPins", 3307823510), 1, new cljs.core.Keyword(null, "wordLength", "wordLength", 2280059394), 1], true)], true)], true);
...
"data", "data", 1016980252), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "numPins", "numPins", 3307823510), 4, new cljs.core.Keyword(null, "wordLength", "wordLength", 2280059394), 1, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), new cljs.core.Keyword(null, "ip0", "ip0", 1014008667), new cljs.core.Keyword(null, 
"source-field", "source-field", 1240617018), new cljs.core.Keyword(null, "q", "q", 1013904355)], true), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), new cljs.core.Keyword(null, "ip1", "ip1", 1014008668), new cljs.core.Keyword(null, "source-field", "source-field", 1240617018), new cljs.core.Keyword(null, "q", "q", 1013904355)], true), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), 
...
"control", "control", 1965447375), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "numPins", "numPins", 3307823510), 1, new cljs.core.Keyword(null, "wordLength", "wordLength", 2280059394), 2, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), new cljs.core.Keyword(null, "ip4", "ip4", 1014008671), new cljs.core.Keyword(null, 
...
"data", "data", 1016980252), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "numPins", "numPins", 3307823510), 4, new cljs.core.Keyword(null, "wordLength", "wordLength", 2280059394), 8, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), new cljs.core.Keyword(null, "ip5", "ip5", 1014008672), new cljs.core.Keyword(null, 
...
true, false, false, true, true, false, false], true)], true), new cljs.core.Keyword(null, "inputs", "inputs", 4125005147), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "enable", "enable", 4010023157), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "num-pins", "num-pins", 3373805271), 1, new cljs.core.Keyword(null, "word-length", "word-length", 4354454139), 1, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, 
...
cljs.core.PersistentVector.fromArray([false], true)], true), new cljs.core.Keyword(null, "inputs", "inputs", 4125005147), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "num-pins", "num-pins", 3373805271), 1, new cljs.core.Keyword(null, "word-length", "word-length", 4354454139), 1, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, 
...
circuits.comp_logic.do_or = function do_or(args) {
  ...
  var any_true_nils = cljs.core.map.call(null, function(n_tuples) {
    return function(p1__4825_SHARP_) {
      return cljs.core.some.call(null, cljs.core.true_QMARK_, p1__4825_SHARP_)
    }
  }(n_tuples), n_tuples);
...
circuits.comp_logic.do_xor = function do_xor(args) {
  ...
  var filtered_true = cljs.core.map.call(null, function(n_tuples) {
    return function(p1__4826_SHARP_) {
      return cljs.core.filter.call(null, cljs.core.true_QMARK_, p1__4826_SHARP_)
    }
  }(n_tuples), n_tuples);
...
goog.require("circuits.validate");
circuits.core.circuit = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
circuits.core.set_state = function set_state(component_map) {
  return cljs.core.reset_BANG_.call(null, circuits.core.circuit, component_map)
};
...
circuits.core.generate_id = function generate_id(species, circuit) {
  var same_species = cljs.core.filter.call(null, function(p1__4827_SHARP_) {
    return cljs.core._EQ_.call(null, p1__4827_SHARP_.call(null, new cljs.core.Keyword(null, "species", "species", 3300406446)), species)
...
circuits.core.evaluate_component = function evaluate_component(component) {
  ...
  return eval_fn.call(null, component)
};
circuits.core.evaluate = function evaluate(id, state) {
  if(cljs.core.truth_(circuits.validate.validate_state.call(null, state))) {
    var newstate = circuits.core.set_state.call(null, state);
    var result = circuits.core.evaluate_component.call(null, cljs.core.deref.call(null, circuits.core.circuit).call(null, id));
    var ret_val = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "result", "result", 4374444943), result, new cljs.core.Keyword(null, "state", "state", 1123661827), cljs.core.deref.call(null, circuits.core.circuit)], true);
    var cleared_state = circuits.core.clear_state.call(null);
    return ret_val
  }else {
    return null
  }
...
circuits.core.add_connection = function add_connection(src, dst, circuit) {
  ...
  var dst_vector = dst_field.call(null, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182));
  var dst_index = dst.call(null, new cljs.core.Keyword(null, "index", "index", 1114250308));
  var new_connection = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "source-id", "source-id", 3610412927), src.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), new cljs.core.Keyword(null, "source-field", "source-field", 1240617018), src.call(null, new cljs.core.Keyword(null, "field", "field", 1111331948))], true);
  var new_invec = cljs.core.assoc.call(null, dst_vector, dst_index, new_connection);
  var new_circuit = cljs.core.assoc_in.call(null, circuit, cljs.core.PersistentVector.fromArray([dst.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), new cljs.core.Keyword(null, "inputs", "inputs", 4125005147), dst.call(null, new cljs.core.Keyword(null, "field", "field", 1111331948)), new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182)], true), new_invec);
  return new_circuit
};
circuits.core.inner_fn = function inner_fn(mapping) {
  var state = cljs.core.deref.call(null, circuits.core.circuit);
  var source_component = state.call(null, mapping.call(null, new cljs.core.Keyword(null, "source-id", "source-id", 3610412927)));
  ...
  var result = the_outputs.call(null, mapping.call(null, new cljs.core.Keyword(null, "source-field", "source-field", 1240617018)));
  return result
};
circuits.core.gen_input_field = function gen_input_field(kvpair) {
  return cljs.core.PersistentArrayMap.fromArray([cljs.core.key.call(null, kvpair), cljs.core.map.call(null, circuits.core.inner_fn, cljs.core.val.call(null, kvpair).call(null, new cljs.core.Keyword(null, "connection-mappings", "connection-mappings", 1076286182)))], true)
};
circuits.core.gen_inputs = function gen_inputs(component) {
  ...
  var input_fields = cljs.core.map.call(null, circuits.core.gen_input_field, input_maps);
...
1 > cljs.core.count.call(null, cljs.core.PersistentVector.fromArray([1, 2], true));
cljs.core.count.call(null, cljs.core.PersistentVector.fromArray([1, 2], true));
circuits.core.and_eval = function and_eval(andgate) {
  var inputs = circuits.core.gen_inputs.call(null, andgate);
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "q", "q", 1013904355), circuits.comp_logic.do_and.call(null, inputs)], true)
};
...
circuits.core.or_eval = function or_eval(orgate) {
  ...
  return circuits.comp_logic.do_or.call(null, inputs)
};
...
circuits.core.xor_eval = function xor_eval(xorgate) {
  ...
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "q", "q", 1013904355), circuits.comp_logic.do_xor.call(null, inputs)], true)
};
...
circuits.core.decoder_eval = function decoder_eval(decoder) {
  ...
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "q", "q", 1013904355), circuits.comp_logic.do_decode.call(null, input)], true)
};
...
circuits.core.register_eval = function register_eval(register) {
  ...
  if(cljs.core.truth_(enabled)) {
    var updated_state_4828 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.first.call(null, inputs.call(null, new cljs.core.Keyword(null, "data", "data", 1016980252))));
    var updated_register_4829 = cljs.core.assoc.call(null, register, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4828);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, register.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_register_4829)
  }else {
  }
...
circuits.core.d_flipflop_eval = function d_flipflop_eval(dff) {
  ...
  var enabled = inputs.call(null, new cljs.core.Keyword(null, "enable", "enable", 4010023157));
  if(cljs.core.truth_(enabled)) {
    var updated_state_4830 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.vec.call(null, cljs.core.first.call(null, inputs.call(null, new cljs.core.Keyword(null, "data", "data", 1016980252)))));
    var updated_dff_4831 = cljs.core.assoc.call(null, dff, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4830);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, dff.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_dff_4831)
  }else {
  }
...
circuits.core.t_flipflop_eval = function t_flipflop_eval(tff) {
  ...
  var enabled = inputs.call(null, new cljs.core.Keyword(null, "enable", "enable", 4010023157));
  if(cljs.core.truth_(enabled)) {
    var updated_state_4832 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core.not, data)));
    var updated_dff_4833 = cljs.core.assoc.call(null, tff, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4832);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, tff.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_dff_4833)
  }else {
  }
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "q", "q", 1013904355), data, new cljs.core.Keyword(null, "q-bar", "q-bar", 1119700009), cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core.not, data))], true)
};
