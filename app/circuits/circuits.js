...
circuits.core.add_component_js = function add_component_js(species, circuit, display) {
  var circuit_map_4825 = circuits.core.map_json.call(null, circuit);
  var display_map_4826 = circuits.core.map_json.call(null, display);
  cljs.core.clj__GT_js.call(null, circuits.core.add_component.call(null, species, circuit_map_4825, display_map_4826));
  circuits.core.add_connection_js = function add_connection_js(src, dst, circuit__$1) {
    return circuits.core.add_connection.call(null, circuits.core.map_json.call(null, src), circuits.core.map_json.call(null, dst), circuits.core.map_json.call(null, circuit__$1))
  };
...
circuits.core.gen_input_field = function gen_input_field(kvpair) {
  return cljs.core.PersistentArrayMap.fromArray([cljs.core.key.call(null, kvpair), cljs.core.map.call(null, circuits.core.inner_fn, cljs.core.val.call(null, kvpair).call(null, new cljs.core.Keyword(null, "connections", "connections", 2738507975)))], true)
};
...
circuits.core.register_eval = function register_eval(register) {
  ...
  if(cljs.core.truth_(enabled)) {
    var updated_state_4827 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.first.call(null, inputs.call(null, new cljs.core.Keyword(null, "data", "data", 1016980252))));
    var updated_register_4828 = cljs.core.assoc.call(null, register, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4827);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, register.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_register_4828)
  }else {
  }
...
circuits.core.d_flipflop_eval = function d_flipflop_eval(dff) {
  ...
  var enabled = inputs.call(null, new cljs.core.Keyword(null, "enable", "enable", 4010023157));
  if(cljs.core.truth_(enabled)) {
    var updated_state_4829 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.vec.call(null, cljs.core.first.call(null, inputs.call(null, new cljs.core.Keyword(null, "data", "data", 1016980252)))));
    var updated_dff_4830 = cljs.core.assoc.call(null, dff, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4829);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, dff.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_dff_4830)
  }else {
  }
...
circuits.core.t_flipflop_eval = function t_flipflop_eval(tff) {
  ...
  var enabled = inputs.call(null, new cljs.core.Keyword(null, "enable", "enable", 4010023157));
  if(cljs.core.truth_(enabled)) {
    var updated_state_4831 = cljs.core.assoc.call(null, state, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core.not, data)));
    var updated_dff_4832 = cljs.core.assoc.call(null, tff, new cljs.core.Keyword(null, "state", "state", 1123661827), updated_state_4831);
    cljs.core.swap_BANG_.call(null, circuits.core.circuit, cljs.core.assoc, tff.call(null, new cljs.core.Keyword(null, "id", "id", 1013907597)), updated_dff_4832)
  }else {
  }
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "q", "q", 1013904355), data, new cljs.core.Keyword(null, "q-bar", "q-bar", 1119700009), cljs.core.vec.call(null, cljs.core.map.call(null, cljs.core.not, data))], true)
};
...
circuits.core.outputpin_eval = function outputpin_eval(outputpin) {
  ...
  var asdf = cljs.core.println.call(null, inputs);
  return inputs
};
